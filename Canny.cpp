...
/* cannyA8_systemc_ref.cpp: EECS 222 solution A8 */
...
SC_MODULE(Monitor){
	...
	******************************************************************************/
	...
	void main(void)
	{
	   ...
	   int i, n;
	   sc_time t1,t2,t;
	   sc_time Tdiff,Tprev=sc_time(0,SC_SEC);
	   double StageDelay, FPS;
	   ...
	   for(i=0; i<IMG_NUM; i++)
	   {
	      ...
	      ****************************************************************************/
	      ...
	      Tdiff = t2 - Tprev;
	      Tprev = t2;
	      StageDelay = (Tdiff) / sc_time(1,SC_SEC);
	      FPS = 1.0 / StageDelay;
	      printf("%9s: %7.3f seconds after previous frame, %6.3f FPS.\n",
			t2.to_string().c_str(), StageDelay, FPS);
...
SC_MODULE(BlurX)
{
	...
	sc_event b0,b1,b2,b3,b4,b5,b6,b7;
	void BlurX_Slice0()
	{
	   while(1){
	      wait(data_received_event);
	      wait(1880/(8*2.5),SC_MS);
	      blur_x(ROWS, COLS, ((ROWS/8)*0), ((ROWS/8)*1));
	...
	void BlurX_Slice1()
	{
	   while(1){
	      wait(data_received_event);
	      wait(1880/(8*2.5),SC_MS);
	      blur_x(ROWS, COLS, ((ROWS/8)*1), ((ROWS/8)*2));
	...
	void BlurX_Slice2()
	{
	   while(1){
	      wait(data_received_event);
	      wait(1880/(8*2.5),SC_MS);
	      blur_x(ROWS, COLS, ((ROWS/8)*2), ((ROWS/8)*3));
	...
	void BlurX_Slice3()
	{
	   while(1){
	      wait(data_received_event);
	      wait(1880/(8*2.5),SC_MS);
	      blur_x(ROWS, COLS, ((ROWS/8)*3), ((ROWS/8)*4));
	...
	void BlurX_Slice4()
	{
	   while(1){
	      wait(data_received_event);
	      wait(1880/(8*2.5),SC_MS);
	      blur_x(ROWS, COLS, ((ROWS/8)*4), ((ROWS/8)*5));
	      b4.notify(SC_ZERO_TIME);
	   }
	}
	void BlurX_Slice5()
	{
	   while(1){
	      wait(data_received_event);
	      wait(1880/(8*2.5),SC_MS);
	      blur_x(ROWS, COLS, ((ROWS/8)*5), ((ROWS/8)*6));
	      b5.notify(SC_ZERO_TIME);
	   }
	}
	void BlurX_Slice6()
	{
	   while(1){
	      wait(data_received_event);
	      wait(1880/(8*2.5),SC_MS);
	      blur_x(ROWS, COLS, ((ROWS/8)*6), ((ROWS/8)*7));
	      b6.notify(SC_ZERO_TIME);
	   }
	}
	void BlurX_Slice7()
	{
	   while(1){
	      wait(data_received_event);
	      wait(1880/(8*2.5),SC_MS);
	      blur_x(ROWS, COLS, ((ROWS/8)*7), ((ROWS/8)*8));
	      b7.notify(SC_ZERO_TIME);
	   }
	}
	...
	SC_CTOR(BlurX)
	{
	   ...
	   SET_STACK_SIZE
	   SC_THREAD(BlurX_Slice5);
	   SET_STACK_SIZE
	   SC_THREAD(BlurX_Slice6);
	   SET_STACK_SIZE
	   SC_THREAD(BlurX_Slice7);
	   SET_STACK_SIZE
	}
};
...
{	
	...
	void BlurY_Slice0()
	{
	   while(1){
	      wait(data_received_event);
	      wait(2010/(8*2.5),SC_MS);
	      blur_y(ROWS, COLS, ((COLS/8)*0), ((COLS/8)*1));
	      b0.notify(SC_ZERO_TIME);
	   }
	}
	void BlurY_Slice1()
	{
	   while(1){
	      wait(data_received_event);
	      wait(2010/(8*2.5),SC_MS);
	      blur_y(ROWS, COLS, ((COLS/8)*1), ((COLS/8)*2));
	      b1.notify(SC_ZERO_TIME);
	   }
	}
	void BlurY_Slice2()
	{
	   while(1){
	      wait(data_received_event);
	      wait(2010/(8*2.5),SC_MS);
	      blur_y(ROWS, COLS, ((COLS/8)*2), ((COLS/8)*3));
	      b2.notify(SC_ZERO_TIME);
	   }
	}
	void BlurY_Slice3()
	{
	   while(1){
	      wait(data_received_event);
	      wait(2010/(8*2.5),SC_MS);
	      blur_y(ROWS, COLS, ((COLS/8)*3), ((COLS/8)*4));
	      b3.notify(SC_ZERO_TIME);
	   }
	}
	void BlurY_Slice4()
	{
	   while(1){
	      wait(data_received_event);
	      wait(2010/(8*2.5),SC_MS);
	      blur_y(ROWS, COLS, ((COLS/8)*4), ((COLS/8)*5));
	      b4.notify(SC_ZERO_TIME);
	   }
	}
	void BlurY_Slice5()
	{
	   while(1){
	      wait(data_received_event);
	      wait(2010/(8*2.5),SC_MS);
	      blur_y(ROWS, COLS, ((COLS/8)*5), ((COLS/8)*6));
	      b5.notify(SC_ZERO_TIME);
	   }
	}
	void BlurY_Slice6()
	{
	   while(1){
	      wait(data_received_event);
	      wait(2010/(8*2.5),SC_MS);
	      blur_y(ROWS, COLS, ((COLS/8)*6), ((COLS/8)*7));
	      b6.notify(SC_ZERO_TIME);
	   }
	}
	void BlurY_Slice7()
	{
	   while(1){
	      wait(data_received_event);
	      wait(2010/(8*2.5),SC_MS);
	      blur_y(ROWS, COLS, ((COLS/8)*7), ((COLS/8)*8));
	      b7.notify(SC_ZERO_TIME);
	   }
	}
	...
	SC_CTOR(BlurY)
	{
	   ...
	   SET_STACK_SIZE
	   SC_THREAD(BlurY_Slice5);
	   SET_STACK_SIZE
	   SC_THREAD(BlurY_Slice6);
	   SET_STACK_SIZE
	   SC_THREAD(BlurY_Slice7);
	   SET_STACK_SIZE
	}
};
...
{	
	...
	sc_fifo_out<IMAGE> img_q;
	sc_fifo_out<FKERNAL> knl_q1,knl_q2;
	//sc_fifo<FIMAGE> tmp_q;
	sc_fifo_out<int> int_q1,int_q2;
...
SC_MODULE(DUT)
{
	...
	,blury("blury")
	{
	   ...
	   gaussian_smooth.img_q.bind(img_q);
	   gaussian_smooth.int_q1.bind(int_q1);
           gaussian_smooth.int_q2.bind(int_q2);
           gaussian_smooth.knl_q1.bind(knl_q1);
           gaussian_smooth.knl_q2.bind(knl_q2);
